...
using Masofa.Depricated.DataAccess.DepricatedUmapiServerOne.Models;
using Microsoft.EntityFrameworkCore;

namespace Masofa.Depricated.DataAccess.DepricatedUmapiServerOne;

public partial class DepricatedUmapiServerOneDbContext : DbContext
{
    public DepricatedUmapiServerOneDbContext()
    {
    }

    public DepricatedUmapiServerOneDbContext(DbContextOptions<DepricatedUmapiServerOneDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=80.80.213.218;Port=15432;Database=umapi;Username=postgres;Password=pgPassw0rd", x => x
                .UseNodaTime()
                .UseNetTopologySuite());
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Templ>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.CropId, e.Version }, "ix_templ_crop").IsUnique();
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.IdParentId)
                .HasMaxLength(128)
                .HasColumnName("id;parent_id");
            entity.Property(e => e.Name)
                .HasMaxLength(64)
                .HasColumnName("name");
            entity.Property(e => e.ParentId).HasColumnName("parent_id");
