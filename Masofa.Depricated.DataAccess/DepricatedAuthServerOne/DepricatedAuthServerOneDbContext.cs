...
using Masofa.Depricated.DataAccess.DepricatedAuthServerOne.Models;
using Microsoft.EntityFrameworkCore;

namespace Masofa.Depricated.DataAccess.DepricatedAuthServerOne;

public partial class DepricatedAuthServerOneDbContext : DbContext
{
    public DepricatedAuthServerOneDbContext()
    {
    }

    public DepricatedAuthServerOneDbContext(DbContextOptions<DepricatedAuthServerOneDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=80.80.213.218;Port=15432;Database=auth;Username=postgres;Password=pgPassw0rd", x => x
                .UseNodaTime()
                .UseNetTopologySuite());
