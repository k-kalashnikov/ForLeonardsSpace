...
/// <summary>
/// Справочник дополнительных характеристик сортов
/// </summary>
[MigrationCompare(CompareToType = typeof(Masofa.Common.Models.Dictionaries.VarietyFeature))]
public partial class VarietyFeature
{
    /// <summary>
    /// Идентификатор
    /// </summary>
