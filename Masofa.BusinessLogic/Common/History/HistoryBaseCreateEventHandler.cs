...
{
    public class HistoryBaseCreateEventHandler<TModel, TDbContext> : INotificationHandler<BaseCreateEvent<TModel, TDbContext>>
        where TModel : BaseEntity
        where TDbContext : DbContext
    {
        private readonly IServiceProvider _serviceProvider;

        public HistoryBaseCreateEventHandler(IServiceProvider serviceProvider)
        {
        ...
        public async Task Handle(BaseCreateEvent<TModel, TDbContext> notification, CancellationToken cancellationToken)
        {
            ...
            historyEntry.OwnerId = entity.Id;
            historyEntry.NewModel = entity;
