...
{
    public class HistoryBaseDeleteEventHandler<TModel, TDbContext> : INotificationHandler<BaseDeleteEvent<TModel, TDbContext>>
        where TModel : BaseEntity
        where TDbContext : DbContext
    {
        private readonly IServiceProvider _serviceProvider;

        public HistoryBaseDeleteEventHandler(IServiceProvider serviceProvider)
        {
        ...
        public async Task Handle(BaseDeleteEvent<TModel, TDbContext> notification, CancellationToken cancellationToken)
        {
            ...
            var oldEntity = notification.Model;
            historyEntry.OwnerId = oldEntity.Id;
