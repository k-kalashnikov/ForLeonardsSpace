...
{
    public class GetAnomalyPolygonsBySeasonAndDateCommand : IRequest<List<AnomalyPolygon>>
    {
        [Required]
    ...
    public class GetPolygonsBySeasonAndDateCommandHandler : IRequestHandler<GetAnomalyPolygonsBySeasonAndDateCommand, List<AnomalyPolygon>>
    {
        ...
        public GetPolygonsBySeasonAndDateCommandHandler(
        ...
        public async Task<List<AnomalyPolygon>> Handle(GetAnomalyPolygonsBySeasonAndDateCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                query = query.Where(ap => ap.SeasonId == request.SeasonId && DateOnly.FromDateTime(ap.OriginalDate) == request.Date);
