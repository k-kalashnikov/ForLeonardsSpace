...
namespace Masofa.DataAccess
{
    ...
    /// </remarks>
    public class MasofaUgmDbContextFactory : IDesignTimeDbContextFactory<MasofaUgmDbContext>
    {
        public MasofaUgmDbContext CreateDbContext(string[] args)
        {
            var optionsBuilder = new DbContextOptionsBuilder<MasofaUgmDbContext>();
            ...
            return new MasofaUgmDbContext(optionsBuilder.Options);
        }
    }
}
