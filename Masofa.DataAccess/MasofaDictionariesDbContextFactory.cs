...
namespace Masofa.DataAccess
{
	...
	/// </remarks>
	public class MasofaDictionariesDbContextFactory : IDesignTimeDbContextFactory<MasofaDictionariesDbContext>
	{
		public MasofaDictionariesDbContext CreateDbContext(string[] args)
		{
            var optionsBuilder = new DbContextOptionsBuilder<MasofaDictionariesDbContext>();
            ...
            return new MasofaDictionariesDbContext(optionsBuilder.Options);
        }
	}
}
