...
namespace Masofa.DataAccess
{
    ...
    /// </remarks>
    public class MasofaUAVDbContextFactory : IDesignTimeDbContextFactory<MasofaUAVDbContext>
    {
        public MasofaUAVDbContext CreateDbContext(string[] args)
        {
            var optionsBuilder = new DbContextOptionsBuilder<MasofaUAVDbContext>();
            ...
            return new MasofaUAVDbContext(optionsBuilder.Options);
        }
    }
}
