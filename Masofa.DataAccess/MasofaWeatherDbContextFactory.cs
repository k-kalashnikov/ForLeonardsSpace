...
namespace Masofa.DataAccess
{
	...
	/// </remarks>
    public class MasofaWeatherDbContextFactory : IDesignTimeDbContextFactory<MasofaWeatherDbContext>
    {
        public MasofaWeatherDbContext CreateDbContext(string[] args)
        {
			var optionsBuilder = new DbContextOptionsBuilder<MasofaWeatherDbContext>();
            ...
            return new MasofaWeatherDbContext(optionsBuilder.Options);
        }
    }
}
