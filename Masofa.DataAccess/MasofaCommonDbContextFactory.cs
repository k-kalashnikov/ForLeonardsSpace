...
namespace Masofa.DataAccess
{
	...
	/// </remarks>
	public class MasofaCommonDbContextFactory : IDesignTimeDbContextFactory<MasofaCommonDbContext>
	{
		public MasofaCommonDbContext CreateDbContext(string[] args)
		{
            var optionsBuilder = new DbContextOptionsBuilder<MasofaCommonDbContext>();
            ...
            return new MasofaCommonDbContext(optionsBuilder.Options);
        }
	}
}
