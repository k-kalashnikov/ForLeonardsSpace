    ...
    public partial class Init_Database : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AgroClimaticZoneMonthNormHistories",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgroClimaticZoneMonthNormHistories", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AgroClimaticZoneNormHistories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CreateAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgroClimaticZoneNormHistories", x => x.Id);
                });
        }
