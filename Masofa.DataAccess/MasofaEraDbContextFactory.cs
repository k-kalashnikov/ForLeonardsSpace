...
namespace Masofa.DataAccess
{
	...
	/// </remarks>
	public class MasofaEraDbContextFactory : IDesignTimeDbContextFactory<MasofaEraDbContext>
    {
        public MasofaEraDbContext CreateDbContext(string[] args)
        {
            var optionsBuilder = new DbContextOptionsBuilder<MasofaEraDbContext>();
            ...
            return new MasofaEraDbContext(optionsBuilder.Options);
        }
    }
}
