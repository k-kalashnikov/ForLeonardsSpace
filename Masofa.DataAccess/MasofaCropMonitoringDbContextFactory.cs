...
namespace Masofa.DataAccess
{
	...
	/// </remarks>
    public class MasofaCropMonitoringDbContextFactory : IDesignTimeDbContextFactory<MasofaCropMonitoringDbContext>
    {
        public MasofaCropMonitoringDbContext CreateDbContext(string[] args)
        {
            var optionsBuilder = new DbContextOptionsBuilder<MasofaCropMonitoringDbContext>();
            ...
            return new MasofaCropMonitoringDbContext(optionsBuilder.Options);
        }
    }
}
