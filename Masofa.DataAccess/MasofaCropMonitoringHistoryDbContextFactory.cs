...
namespace Masofa.DataAccess
{
	...
	/// </remarks>
    public class MasofaCropMonitoringHistoryDbContextFactory : IDesignTimeDbContextFactory<MasofaCropMonitoringHistoryDbContext>
    {
        public MasofaCropMonitoringHistoryDbContext CreateDbContext(string[] args)
        {
            var optionsBuilder = new DbContextOptionsBuilder<MasofaCropMonitoringHistoryDbContext>();
            ...
            return new MasofaCropMonitoringHistoryDbContext(optionsBuilder.Options);
        }
    }
}
