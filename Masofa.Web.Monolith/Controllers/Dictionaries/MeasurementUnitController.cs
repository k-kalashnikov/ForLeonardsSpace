...
{
    /// <summary>
    /// Предоставляет API-методы для управления единицами измерения
    /// </summary>
    [Route("dictionaries/[controller]")]
    [ApiExplorerSettings(GroupName = "Dictionaries")]
    public class MeasurementUnitController : BaseDictionaryController<MeasurementUnit, MasofaDictionariesDbContext>
    {
        /// <summary>
