...
{
    /// <summary>
    /// Предоставляет API-методы для управления видами деятельности юридических и физических лиц
    /// </summary>
    [Route("dictionaries/[controller]")]
    [ApiExplorerSettings(GroupName = "Dictionaries")]
    public class BusinessTypeController : BaseDictionaryController<BusinessType, MasofaDictionariesDbContext>
    {
        /// <summary>
        /// Инициализирует новый экземпляр <see cref="BusinessTypeController"/>.
        /// </summary>
