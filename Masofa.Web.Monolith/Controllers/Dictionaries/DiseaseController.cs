...
{
    /// <summary>
    /// Предоставляет API-методы для управления болезнями растений
    /// </summary>
    [Route("dictionaries/[controller]")]
    [ApiExplorerSettings(GroupName = "Dictionaries")]
    public class DiseaseController : BaseDictionaryController<Disease, MasofaDictionariesDbContext>
    {
        /// <summary>
        /// Инициализирует новый экземпляр <see cref="DiseaseController"/>.
        /// </summary>
