...
{
    /// <summary>
    /// Предоставляет API-методы для управления пестицидами и агрохимикатами
    /// </summary>
    [Route("dictionaries/[controller]")]
    [ApiExplorerSettings(GroupName = "Dictionaries")]
    public class PesticideController : BaseDictionaryController<Pesticide, MasofaDictionariesDbContext>
    {
        /// <summary>
        /// Инициализирует новый экземпляр <see cref="PesticideController"/>.
        /// </summary>
        ...
        public PesticideController(
            ...
            ILogger<PesticideController> logger,
