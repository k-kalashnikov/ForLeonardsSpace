...
{
    /// <summary>
    /// Предоставляет API-методы для управления погодными станциями
    /// </summary>
    [Route("dictionaries/[controller]")]
    [ApiExplorerSettings(GroupName = "Dictionaries")]
    public class WeatherStationController : BaseDictionaryController<WeatherStation, MasofaDictionariesDbContext>
    {
        /// <summary>
        /// Инициализирует новый экземпляр <see cref="WeatherStationController"/>.
        /// </summary>
