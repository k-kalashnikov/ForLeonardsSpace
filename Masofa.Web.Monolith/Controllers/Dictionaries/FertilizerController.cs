...
{
    /// <summary>
    /// Предоставляет API-методы для управления удобрениями
    /// </summary>
    [Route("dictionaries/[controller]")]
    [ApiExplorerSettings(GroupName = "Dictionaries")]
    public class FertilizerController : BaseDictionaryController<Fertilizer, MasofaDictionariesDbContext>
    {
        /// <summary>
        /// Инициализирует новый экземпляр <see cref="FertilizerController"/>.
        /// </summary>
        ...
        public FertilizerController(
            ...
            ILogger<FertilizerController> logger,
