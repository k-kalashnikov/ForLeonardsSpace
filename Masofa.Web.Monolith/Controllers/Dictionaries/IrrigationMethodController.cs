...
{
    /// <summary>
    /// Предоставляет API-методы для управления технологиями орошения
    /// </summary>
    [Route("dictionaries/[controller]")]
    [ApiExplorerSettings(GroupName = "Dictionaries")]
    public class IrrigationMethodController : BaseDictionaryController<IrrigationMethod, MasofaDictionariesDbContext>
    {
        /// <summary>
        /// Инициализирует новый экземпляр <see cref="IrrigationMethodController"/>.
        /// </summary>
        ...
        public IrrigationMethodController(
