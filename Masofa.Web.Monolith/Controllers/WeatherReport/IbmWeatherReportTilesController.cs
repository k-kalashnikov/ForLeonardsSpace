...
namespace Masofa.Web.Monolith.Controllers.WeatherReport
{
    ...
    public class IbmWeatherReportTilesController : BaseController
    {
        ...
        public IbmWeatherReportTilesController(
            ILogger<IbmWeatherReportTilesController> logger,
        ...
        public async Task<List<string>> GetAvailableLayers()
        {
            ...
            try
            {
                ...
                result = typeof(BaseIbmWeatherReport)
            ...
            [Required] CoordinateSystemEnum coordinateSystem = CoordinateSystemEnum.Epsg4326Wgs84)
        {
            ...
            try
            {
                ...
                {
                    var errorMsg = LogMessageResource.LayerNotFoundOnServer();
                ...
                var tileUrl = $"{GeoServerOptions.GeoServerUrl}/geoserver/gwc/service/wmts/rest/" +
                              $"{GeoServerOptions.Workspace}:Ibm{layerName}/raster/EPSG:900913/EPSG:900913:{z}/{tileY}/{tileX}?format=image/png";
