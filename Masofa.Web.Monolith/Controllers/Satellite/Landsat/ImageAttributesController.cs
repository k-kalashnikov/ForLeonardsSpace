...
namespace Masofa.Web.Monolith.Controllers.Satellite
{
    ...
    public class ImageAttributesController : BaseCrudController<ImageAttributesEntity, MasofaLandsatDbContext>
    {
        public ImageAttributesController(
            IFileStorageProvider fileStorageProvider,
            MasofaLandsatDbContext dbContext,
            UserManager<User> userManager,
            ILogger<ImageAttributesController> logger,
