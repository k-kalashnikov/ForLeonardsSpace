...
namespace Masofa.Web.Monolith.Controllers.Satellite
{
    ...
    public class LandsatSourceMetadataController : BaseCrudController<LandsatSourceMetadataEntity, MasofaLandsatDbContext>
    {
        public LandsatSourceMetadataController(
            IFileStorageProvider fileStorageProvider,
            MasofaLandsatDbContext dbContext,
            UserManager<User> userManager,
            ILogger<LandsatSourceMetadataController> logger,
