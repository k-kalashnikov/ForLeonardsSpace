...
namespace Masofa.Web.Monolith.Controllers.Satellite
{
    ...
    public class StQualityAssetController : BaseCrudController<StQualityAssetEntity, MasofaLandsatDbContext>
    {
        public StQualityAssetController(
            IFileStorageProvider fileStorageProvider,
            MasofaLandsatDbContext dbContext,
            UserManager<User> userManager,
            ILogger<StQualityAssetController> logger,
