...
namespace Masofa.Web.Monolith.Controllers.Satellite
{
    ...
    public class SrBandAssetController : BaseCrudController<SrBandAssetEntity, MasofaLandsatDbContext>
    {
        public SrBandAssetController(
            IFileStorageProvider fileStorageProvider,
            MasofaLandsatDbContext dbContext,
            UserManager<User> userManager,
            ILogger<SrBandAssetController> logger,
