...
namespace Masofa.Web.Monolith.Controllers.Satellite
{
    ...
    public class LandsatSrStacMetadataController : BaseCrudController<LandsatSrStacMetadataEntity, MasofaLandsatDbContext>
    {
        public LandsatSrStacMetadataController(
            IFileStorageProvider fileStorageProvider,
            MasofaLandsatDbContext dbContext,
            UserManager<User> userManager,
            ILogger<LandsatSrStacMetadataController> logger,
