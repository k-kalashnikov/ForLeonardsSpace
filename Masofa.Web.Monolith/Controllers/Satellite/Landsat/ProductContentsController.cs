...
namespace Masofa.Web.Monolith.Controllers.Satellite
{
    ...
    public class ProductContentsController : BaseCrudController<ProductContentsEntity, MasofaLandsatDbContext>
    {
        public ProductContentsController(
            IFileStorageProvider fileStorageProvider,
            MasofaLandsatDbContext dbContext,
            UserManager<User> userManager,
            ILogger<ProductContentsController> logger,
