...
namespace Masofa.Web.Monolith.Controllers.Satellite
{
    ...
    public class StAuxiliaryAssetController : BaseCrudController<StAuxiliaryAssetEntity, MasofaLandsatDbContext>
    {
        public StAuxiliaryAssetController(
            IFileStorageProvider fileStorageProvider,
            MasofaLandsatDbContext dbContext,
            UserManager<User> userManager,
            ILogger<StAuxiliaryAssetController> logger,
