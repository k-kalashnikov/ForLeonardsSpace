...
namespace Masofa.Web.Monolith.Controllers.Satellite
{
    ...
    public class SentinelInspireMetadataController : BaseCrudController<SentinelInspireMetadata, MasofaSentinelDbContext>
    {
        public SentinelInspireMetadataController(
            IFileStorageProvider fileStorageProvider, 
            MasofaSentinelDbContext dbContext, 
            UserManager<User> userManager, 
            ILogger<SentinelInspireMetadataController> logger, 
