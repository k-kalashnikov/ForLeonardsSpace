...
namespace Masofa.Web.Monolith.Controllers.Satellite
{
    ...
    public class Sentinel2ProductMetadataController : BaseCrudController<Sentinel2ProductMetadata, MasofaSentinelDbContext>
    {
        public Sentinel2ProductMetadataController(
            IFileStorageProvider fileStorageProvider,
            MasofaSentinelDbContext dbContext,
            UserManager<User> userManager,
            ILogger<Sentinel2ProductMetadataController> logger,
