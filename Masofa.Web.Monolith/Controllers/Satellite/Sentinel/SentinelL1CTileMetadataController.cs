...
namespace Masofa.Web.Monolith.Controllers.Satellite
{
    ...
    public class SentinelL1CTileMetadataController : BaseCrudController<SentinelL1CTileMetadata, MasofaSentinelDbContext>
    {
        public SentinelL1CTileMetadataController(
            IFileStorageProvider fileStorageProvider,
            MasofaSentinelDbContext dbContext,
            UserManager<User> userManager,
            ILogger<SentinelL1CTileMetadataController> logger,
