...
//{
//    [SystemBackgroundTask(BackgroundTaskType.NotCritical, "GndviSeasonReportJob", "Indices")]
//    public class GndviSeasonReportJob : BaseJob<GndviSeasonReportJobResult>, IJob
//    {
...
//        {
//            Logger.LogInformation("GndviSeasonReportJob started");

//            var productQueue = await MasofaSentinelDbContext.Set<Sentinel2ProductQueue>()
//                .Where(m => m.QueueStatus == ProductQueueStatusType.EviReportSeason)
//                .ToListAsync();
...
//                try
//                {
//                    var indexes = await MasofaIndicesDbContext.GndviPoints
...
//                    var models = new List<GndviSeasonReport>();
...
//                    await MasofaIndicesDbContext.GndviSeasonReports.AddRangeAsync(models);
//                    await MasofaIndicesDbContext.SaveChangesAsync();

//                    var queueItem = productQueue.FirstOrDefault(p => p.ProductId == product.ProductId);
//                    if (queueItem != null)
//                    {
//                        queueItem.QueueStatus = ProductQueueStatusType.GndviReportSeason;
...
//            Logger.LogInformation("GndviSeasonReportJob ended");
//        }
//    }

//    public class GndviSeasonReportJobResult : BaseJobResult
//    {
//        int count = 0;
//    }
//}
