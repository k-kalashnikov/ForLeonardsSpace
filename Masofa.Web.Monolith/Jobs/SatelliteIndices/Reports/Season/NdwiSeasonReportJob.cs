...
//{
//    [SystemBackgroundTask(BackgroundTaskType.NotCritical, "NdwiSeasonReportJob", "Indices")]
//    public class NdwiSeasonReportJob : BaseJob<NdwiSeasonReportJobResult>, IJob
//    {
...
//        {
//            Logger.LogInformation("NdwiSeasonReportJob started");

//            var productQueue = await MasofaSentinelDbContext.Set<Sentinel2ProductQueue>()
//                .Where(m => m.QueueStatus == ProductQueueStatusType.NdmiReportSeason)
//                .ToListAsync();
...
//                try
//                {
//                    var indexes = await MasofaIndicesDbContext.NdwiPoints
...
//                    var models = new List<NdwiSeasonReport>();
...
//                    await MasofaIndicesDbContext.NdwiSeasonReports.AddRangeAsync(models);
//                    await MasofaIndicesDbContext.SaveChangesAsync();

//                    var queueItem = productQueue.FirstOrDefault(p => p.ProductId == product.ProductId);
//                    if (queueItem != null)
//                    {
//                        queueItem.QueueStatus = ProductQueueStatusType.NdwiReportSeason;
...
//            Logger.LogInformation("NdwiSeasonReportJob ended");
//        }
//    }

//    public class NdwiSeasonReportJobResult : BaseJobResult
//    {
//        int count = 0;
//    }
//}
