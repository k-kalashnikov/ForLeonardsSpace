...
//{
//    [SystemBackgroundTask(BackgroundTaskType.NotCritical, "MndwiSeasonReportJob", "Indices")]
//    public class MndwiSeasonReportJob : BaseJob<MndwiSeasonReportJobResult>, IJob
//    {
...
//        {
//            Logger.LogInformation("MndwiSeasonReportJob started");

//            var productQueue = await MasofaSentinelDbContext.Set<Sentinel2ProductQueue>()
//                .Where(m => m.QueueStatus == ProductQueueStatusType.GndviReportSeason)
//                .ToListAsync();
...
//                try
//                {
//                    var indexes = await MasofaIndicesDbContext.MndwiPoints
...
//                    var models = new List<MndwiSeasonReport>();
...
//                    await MasofaIndicesDbContext.MndwiSeasonReports.AddRangeAsync(models);
//                    await MasofaIndicesDbContext.SaveChangesAsync();

//                    var queueItem = productQueue.FirstOrDefault(p => p.ProductId == product.ProductId);
//                    if (queueItem != null)
//                    {
//                        queueItem.QueueStatus = ProductQueueStatusType.MndwiReportSeason;
...
//            Logger.LogInformation("MndwiSeasonReportJob ended");
//        }
//    }

//    public class MndwiSeasonReportJobResult : BaseJobResult
//    {
//        int count = 0;
//    }
//}
