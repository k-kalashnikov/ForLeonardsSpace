...
//{
//    [SystemBackgroundTask(BackgroundTaskType.NotCritical, "EviSeasonReportJob", "Indices")]
//    public class EviSeasonReportJob : BaseJob<EviSeasonReportJobResult>, IJob
//    {
...
//        {
//            Logger.LogInformation("EviSeasonReportJob started");

//            var productQueue = await MasofaSentinelDbContext.Set<Sentinel2ProductQueue>()
//                .Where(m => m.QueueStatus == ProductQueueStatusType.ArvirReportSeason)
//                .ToListAsync();
...
//                try
//                {
//                    var indexes = await MasofaIndicesDbContext.EviPoints
...
//                    var models = new List<EviSeasonReport>();
...
//                    await MasofaIndicesDbContext.EviSeasonReports.AddRangeAsync(models);
//                    await MasofaIndicesDbContext.SaveChangesAsync();

//                    var queueItem = productQueue.FirstOrDefault(p => p.ProductId == product.ProductId);
//                    if (queueItem != null)
//                    {
//                        queueItem.QueueStatus = ProductQueueStatusType.EviReportSeason;
...
//            Logger.LogInformation("EviSeasonReportJob ended");
//        }
//    }

//    public class EviSeasonReportJobResult : BaseJobResult
//    {
//        int count = 0;
//    }
//}
