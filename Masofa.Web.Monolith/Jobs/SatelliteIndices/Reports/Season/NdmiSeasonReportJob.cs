...
//{
//    [SystemBackgroundTask(BackgroundTaskType.NotCritical, "NdmiSeasonReportJob", "Indices")]
//    public class NdmiSeasonReportJob : BaseJob<NdmiSeasonReportJobResult>, IJob
//    {
...
//        {
//            Logger.LogInformation("NdmiSeasonReportJob started");

//            var productQueue = await MasofaSentinelDbContext.Set<Sentinel2ProductQueue>()
//                .Where(m => m.QueueStatus == ProductQueueStatusType.MndwiReportSeason)
//                .ToListAsync();
...
//                try
//                {
//                    var indexes = await MasofaIndicesDbContext.NdmiPoints
...
//                    var models = new List<NdmiSeasonReport>();
...
//                    await MasofaIndicesDbContext.NdmiSeasonReports.AddRangeAsync(models);
//                    await MasofaIndicesDbContext.SaveChangesAsync();

//                    var queueItem = productQueue.FirstOrDefault(p => p.ProductId == product.ProductId);
//                    if (queueItem != null)
//                    {
//                        queueItem.QueueStatus = ProductQueueStatusType.NdmiReportSeason;
...
//            Logger.LogInformation("NdmiSeasonReportJob ended");
//        }
//    }

//    public class NdmiSeasonReportJobResult : BaseJobResult
//    {
//        int count = 0;
//    }
//}
