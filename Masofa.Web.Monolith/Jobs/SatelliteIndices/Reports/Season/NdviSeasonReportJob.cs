...
//{
//    [SystemBackgroundTask(BackgroundTaskType.NotCritical, "NdviSeasonReportJob", "Indices")]
//    public class NdviSeasonReportJob : BaseJob<NdviSeasonReportJobResult>, IJob
//    {
...
//        {
//            Logger.LogInformation("NdviSeasonReportJob started");
...
//                try
//                {
//                    var indexes = await MasofaIndicesDbContext.NdviPoints
...
//                    var models = new List<NdviSeasonReport>();
...
//                    await MasofaIndicesDbContext.NdviSeasonReports.AddRangeAsync(models);
//                    await MasofaIndicesDbContext.SaveChangesAsync();

//                    var queueItem = productQueue.FirstOrDefault(p => p.ProductId == product.ProductId);
//                    if (queueItem != null)
//                    {
//                        queueItem.QueueStatus = ProductQueueStatusType.NdviReportSeason;
...
//            Logger.LogInformation("NdviSeasonReportJob ended");
//        }
//    }

//    public class NdviSeasonReportJobResult : BaseJobResult
//    {
//        int count = 0;
//    }
//}
