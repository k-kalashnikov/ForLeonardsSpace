...
//{
//    [SystemBackgroundTask(BackgroundTaskType.NotCritical, "OrviSeasonReportJob", "Indices")]
//    public class OrviSeasonReportJob : BaseJob<OrviSeasonReportJobResult>, IJob
//    {
...
//        {
//            Logger.LogInformation("OrviSeasonReportJob started");

//            var productQueue = await MasofaSentinelDbContext.Set<Sentinel2ProductQueue>()
//                .Where(m => m.QueueStatus == ProductQueueStatusType.NdviReportSeason)
//                .ToListAsync();
...
//                try
//                {
//                    var indexes = await MasofaIndicesDbContext.OrviPoints
...
//                    var models = new List<OrviSeasonReport>();
...
//                    await MasofaIndicesDbContext.OrviSeasonReports.AddRangeAsync(models);
//                    await MasofaIndicesDbContext.SaveChangesAsync();

//                    var queueItem = productQueue.FirstOrDefault(p => p.ProductId == product.ProductId);
//                    if (queueItem != null)
//                    {
//                        queueItem.QueueStatus = ProductQueueStatusType.OrviReportSeason;
...
//            Logger.LogInformation("OrviSeasonReportJob ended");
//        }
//    }

//    public class OrviSeasonReportJobResult : BaseJobResult
//    {
//        int count = 0;
//    }
//}
