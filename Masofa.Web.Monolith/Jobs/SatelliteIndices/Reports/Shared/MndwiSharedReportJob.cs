...
//{
//    [SystemBackgroundTask(BackgroundTaskType.NotCritical, "MndwiSharedReportJob", "Indices")]
//    public class MndwiSharedReportJob : BaseJob<MndwiReportJobResult>, IJob
//    {
...
//        {
//            Logger.LogInformation("MndwiSharedReportJob started");

//            try
//            {
//                var queueItems = await MasofaSentinelDbContext.Set<Sentinel2ProductQueue>()
//                    .Where(q => q.QueueStatus == ProductQueueStatusType.GndviReportSeason)
//                    .Take(100)
//                    .ToListAsync();
...
//                var sharedReports = new List<MndwiSharedReport>();

//                foreach (var queueItem in queueItems)
//                {
//                    try
//                    {
//                        var points = await MasofaIndicesDbContext.MndwiPoints
...
//                        var seasonReports = await MasofaIndicesDbContext.MndwiSeasonReports
...
//                            var mndwiSharedReport = new MndwiSharedReport()
//                            {
...
//                            sharedReports.Add(mndwiSharedReport);
//                        }

//                        queueItem.QueueStatus = ProductQueueStatusType.MndwiReportShared;
//                    }
//                    catch (Exception ex)
//                    {
...
//                {
//                    await MasofaIndicesDbContext.MndwiSharedReports.AddRangeAsync(sharedReports);
...
//            catch (Exception ex)
//            {
//                Logger.LogError(ex, "Critical error in MndwiSharedReportJob");
//                await MarkJobAsFailed(context);
//            }

//            Logger.LogInformation("MndwiSharedReportJob ended");
//        }
...
//    public class MndwiReportJobResult : BaseJobResult
//    {
//        int count = 0;
//    }
//}
