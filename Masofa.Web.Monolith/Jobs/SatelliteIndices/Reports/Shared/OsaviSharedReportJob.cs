...
//{
//    [SystemBackgroundTask(BackgroundTaskType.NotCritical, "OsaviSharedReportJob", "Indices")]
//    public class OsaviSharedReportJob : BaseJob<OsaviReportJobResult>, IJob
//    {
...
//        {
//            Logger.LogInformation("OsaviSharedReportJob started");

//            try
//            {
//                var queueItems = await MasofaSentinelDbContext.Set<Sentinel2ProductQueue>()
//                    .Where(q => q.QueueStatus == ProductQueueStatusType.OrviReportSeason)
//                    .Take(100)
//                    .ToListAsync();
...
//                var sharedReports = new List<OsaviSharedReport>();

//                foreach (var queueItem in queueItems)
//                {
//                    try
//                    {
//                        var points = await MasofaIndicesDbContext.OsaviPoints
...
//                        var seasonReports = await MasofaIndicesDbContext.OsaviSeasonReports
...
//                            var osaviSharedReport = new OsaviSharedReport()
//                            {
...
//                            sharedReports.Add(osaviSharedReport);
//                        }

//                        queueItem.QueueStatus = ProductQueueStatusType.OsaviReportShared;
//                    }
//                    catch (Exception ex)
//                    {
...
//                {
//                    await MasofaIndicesDbContext.OsaviSharedReports.AddRangeAsync(sharedReports);
...
//            catch (Exception ex)
//            {
//                Logger.LogError(ex, "Critical error in OsaviSharedReportJob");
//                await MarkJobAsFailed(context);
//            }

//            Logger.LogInformation("OsaviSharedReportJob ended");
//        }
...
//    public class OsaviReportJobResult : BaseJobResult
//    {
//        int count = 0;
//    }
//}
