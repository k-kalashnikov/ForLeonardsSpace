...
//{
//    [SystemBackgroundTask(BackgroundTaskType.NotCritical, "EviSharedReportJob", "Indices")]
//    public class EviSharedReportJob : BaseJob<EviReportJobResult>, IJob
//    {
...
//        {
//            Logger.LogInformation("EviSharedReportJob started");

//            try
//            {
//                var queueItems = await MasofaSentinelDbContext.Set<Sentinel2ProductQueue>()
//                    .Where(q => q.QueueStatus == ProductQueueStatusType.ArviReportShared)
//                    .Take(100)
//                    .ToListAsync();
...
//                var sharedReports = new List<EviSharedReport>();

//                foreach (var queueItem in queueItems)
//                {
//                    try
//                    {
//                        var points = await MasofaIndicesDbContext.EviPoints
...
//                        var seasonReports = await MasofaIndicesDbContext.EviSeasonReports
...
//                            var eviSharedReport = new EviSharedReport()
//                            {
...
//                            sharedReports.Add(eviSharedReport);
//                        }

//                        queueItem.QueueStatus = ProductQueueStatusType.EviReportShared;
//                    }
//                    catch (Exception ex)
//                    {
...
//                {
//                    await MasofaIndicesDbContext.EviSharedReports.AddRangeAsync(sharedReports);
...
//            catch (Exception ex)
//            {
//                Logger.LogError(ex, "Critical error in EviSharedReportJob");
//                await MarkJobAsFailed(context);
//            }

//            Logger.LogInformation("EviSharedReportJob ended");
//        }
...
//        }
//    }
//    public class EviReportJobResult : BaseJobResult
//    {
//        int count = 0;
//    }
//}
