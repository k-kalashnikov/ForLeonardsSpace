...
//{
//    [SystemBackgroundTask(BackgroundTaskType.NotCritical, "GndviSharedReportJob", "Indices")]
//    public class GndviSharedReportJob : BaseJob<GndviReportJobResult>, IJob
//    {
...
//        {
//            Logger.LogInformation("GndviSharedReportJob started");

//            try
//            {
//                var queueItems = await MasofaSentinelDbContext.Set<Sentinel2ProductQueue>()
//                    .Where(q => q.QueueStatus == ProductQueueStatusType.EviReportSeason)
//                    .Take(100)
//                    .ToListAsync();
...
//                var sharedReports = new List<GndviSharedReport>();

//                foreach (var queueItem in queueItems)
//                {
//                    try
//                    {
//                        var points = await MasofaIndicesDbContext.GndviPoints
...
//                        var seasonReports = await MasofaIndicesDbContext.GndviSeasonReports
...
//                            var gndviSharedReport = new GndviSharedReport()
//                            {
...
//                            sharedReports.Add(gndviSharedReport);
//                        }

//                        queueItem.QueueStatus = ProductQueueStatusType.GndviReportShared;
//                    }
//                    catch (Exception ex)
//                    {
...
//                {
//                    await MasofaIndicesDbContext.GndviSharedReports.AddRangeAsync(sharedReports);
...
//            catch (Exception ex)
//            {
//                Logger.LogError(ex, "Critical error in GndviSharedReportJob");
//                await MarkJobAsFailed(context);
//            }

//            Logger.LogInformation("GndviSharedReportJob ended");
//        }
...
//    public class GndviReportJobResult : BaseJobResult
//    {
//        int count = 0;
//    }
//}
