...
//{
//    [SystemBackgroundTask(BackgroundTaskType.NotCritical, "NdviSharedReportJob", "Indices")]
//    public class NdviSharedReportJob : BaseJob<NdviReportJobResult>, IJob
//    {
...
//        {
//            Logger.LogInformation("NdviSharedReportJob started");

//            try
//            {
//                var queueItems = await MasofaSentinelDbContext.Set<Sentinel2ProductQueue>()
//                    .Where(q => q.QueueStatus == ProductQueueStatusType.NdmiReportSeason)
//                    .Take(100)
//                    .ToListAsync();
...
//                var sharedReports = new List<NdviSharedReport>();

//                foreach (var queueItem in queueItems)
//                {
//                    try
//                    {
//                        var points = await MasofaIndicesDbContext.NdviPoints
...
//                        var seasonReports = await MasofaIndicesDbContext.NdviSeasonReports
...
//                            var ndviSharedReport = new NdviSharedReport()
//                            {
...
//                            sharedReports.Add(ndviSharedReport);
//                        }

//                        queueItem.QueueStatus = ProductQueueStatusType.NdviReportShared;
//                    }
//                    catch (Exception ex)
//                    {
...
//                {
//                    await MasofaIndicesDbContext.NdviSharedReports.AddRangeAsync(sharedReports);
...
//            catch (Exception ex)
//            {
//                Logger.LogError(ex, "Critical error in NdviSharedReportJob");
//                await MarkJobAsFailed(context);
//            }

//            Logger.LogInformation("NdviSharedReportJob ended");
//        }
...
//    public class NdviReportJobResult : BaseJobResult
//    {
//        int count = 0;
//    }
//}
